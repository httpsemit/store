    ...
    return (
        <div className="space-y-10 pb-12 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                     <h1 className="text-4xl font-black text-gray-900 tracking-tighter leading-none uppercase">Store Pulse</h1>
                ...
                <div className="flex items-center gap-3">
                    <div className="px-6 py-2.5 bg-white rounded-2xl border border-indigo-100 text-xs font-black text-indigo-600 uppercase tracking-widest shadow-lg shadow-indigo-50/50 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {statCards.map((stat, i) => (
                    <div key={i} className="group bg-white p-6 rounded-[32px] shadow-sm border border-gray-100 hover:shadow-2xl hover:border-indigo-100 transition-all flex flex-col relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                    ...
                    <button
                        ...
                        className={`group relative flex flex-col items-start p-6 bg-white text-gray-900 rounded-[32px] shadow-sm border border-gray-100 hover:shadow-2xl hover:border-${item.color}-100 transition-all overflow-hidden`}
                    >
                        ...
                        <h3 className="text-xl font-black text-gray-900 tracking-tight uppercase leading-none">{item.action}</h3>
                    </button>
                ))}
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div className="xl:col-span-2 space-y-8">
                    <div className="bg-white border border-gray-100 rounded-[48px] p-10 shadow-sm relative overflow-hidden group min-h-[400px]">
                        ...
                        <div className="flex items-center justify-between mb-10 relative">
                            <div>
                                <h3 className="text-2xl font-black text-gray-900 tracking-tight leading-none uppercase">Stock Radar</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative">
                            {lowStockAlerts.length > 0 ? (
                                lowStockAlerts.map(alert => (
                                    <div key={alert.productId} className="flex items-center gap-6 p-6 bg-red-50/50 rounded-[32px] border border-red-100 hover:bg-white transition-all group/item shadow-sm">
                                        <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-red-600 shadow-md font-black text-sm">
                                            {alert.currentStock}
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <p className="font-black text-gray-900 text-sm truncate uppercase tracking-tight">{alert.productName}</p>
                ...
                <div className="xl:col-span-1">
                    <div className="bg-white border border-gray-100 rounded-[48px] p-10 shadow-sm group hover:shadow-2xl transition-all h-full">
                        <div className="flex items-center gap-3 mb-10">
                            <div className="p-3 bg-gray-900 text-white rounded-2xl shadow-xl shadow-gray-200">
                                <Wallet size={24} />
                            </div>
                            <div>
                                <h3 className="text-2xl font-black text-gray-900 tracking-tight leading-none uppercase text-nowrap">Daily Expenses</h3>
                        ...
                        <form onSubmit={handleAddExpense} className="space-y-6">
                            <div className="space-y-3">
                                <div className="relative">
                                    <IndianRupee size={16} className="absolute left-6 top-1/2 -translate-y-1/2 text-gray-300" />
                                    <input 
                                        type="number"
                                        required
                                        className="w-full bg-gray-50 border border-gray-100 rounded-[28px] pl-16 pr-8 py-5 text-xl font-black outline-none focus:ring-4 focus:ring-gray-200 transition-all text-gray-900"
                                        placeholder="0.00"
                            ...
                            <div className="space-y-3">
                                <select 
                                    className="w-full bg-gray-50 border border-gray-100 rounded-[28px] px-8 py-5 font-black uppercase text-[10px] tracking-widest outline-none focus:ring-4 focus:ring-gray-200 transition-all appearance-none"
                            ...
                            <div className="space-y-3">
                                <textarea 
                                    className="w-full bg-gray-50 border border-gray-100 rounded-[28px] px-8 py-5 text-xs font-bold outline-none focus:ring-4 focus:ring-gray-200 transition-all text-gray-600 min-h-[100px] resize-none"
                            ...
                            <button 
                                ...
                                type="submit"
                                className="w-full py-5 bg-gray-900 text-white rounded-[28px] font-black uppercase tracking-widest shadow-xl hover:bg-black transition-all active:scale-[0.98] mt-2"
                            >
            ...
            <div className="bg-white border border-gray-100 rounded-[48px] p-10 shadow-sm overflow-hidden">
                <div className="flex items-center justify-between mb-10">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-2xl font-black text-gray-900 tracking-tight leading-none uppercase">Live Feed</h3>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {recentSales.map((sale) => (
                        <div key={sale.id} className="flex items-center justify-between p-6 bg-gray-50/50 border border-gray-100 rounded-[32px] hover:bg-white hover:shadow-xl transition-all group">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="min-w-0">
                                    <p className="text-xl font-black text-gray-900 tracking-tighter leading-none mb-1">₹{sale.total.toLocaleString('en-IN')}</p>
