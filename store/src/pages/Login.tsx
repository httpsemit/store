        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-indigo-900 to-slate-900 flex items-center justify-center p-4 sm:p-6">
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="text-center mb-6 sm:mb-8">
                    <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-white/5 backdrop-blur-sm rounded-2xl sm:rounded-3xl mb-4 sm:mb-5 shadow-2xl border border-white/10">
