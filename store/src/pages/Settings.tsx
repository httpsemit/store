    ...
    return (
        <div className="space-y-10 animate-fade-in pb-12">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <h1 className="text-4xl font-black text-gray-900 tracking-tighter leading-none uppercase">{t('settings')}</h1>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div className="xl:col-span-1 space-y-8">
                            ...
                            {[
                                ...
                                >
                                    <div className="text-left">
                                        <p className="text-sm font-black uppercase tracking-tight">{lang.label}</p>
                                        <p className={clsx("text-[9px] font-bold uppercase tracking-widest", language === lang.id ? "text-indigo-200" : "text-gray-400")}>
                                            {lang.sub}
                                        </p>
                                    </div>
                                    <div className={clsx(
                    ...
                    <div className="bg-white border border-gray-100 rounded-[40px] p-8 shadow-sm">
                        ...
                        <div className="flex items-center justify-between p-2 bg-gray-50 rounded-[32px] border border-gray-100">
                             <button 
                        ...
                        <p className="text-center text-[10px] font-bold text-gray-300 uppercase mt-6 tracking-widest">Dark mode Coming Soon</p>
                    </div>
                </div>

                {/* Account Settings */}
                <div className="xl:col-span-2 space-y-8">
                    <div className="bg-white border border-gray-100 rounded-[40px] p-10 shadow-sm relative overflow-hidden group">
                         <div className="absolute top-0 right-0 p-8">
                            <Shield className="text-indigo-50 group-hover:text-indigo-100 transition-colors" size={140} />
                         </div>
                         
                         <div className="relative">
                            <div className="flex items-center gap-6 mb-10">
                                <div className="w-20 h-20 bg-indigo-600 rounded-[32px] flex items-center justify-center text-white font-black text-3xl shadow-2xl shadow-indigo-100">
                                    {currentUser?.name?.charAt(0) || 'A'}
                                </div>
                                <div>
                                    <h3 className="text-3xl font-black text-gray-900 tracking-tighter leading-none mb-2">{currentUser?.name}</h3>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="bg-gray-50 rounded-[32px] p-8 border border-gray-100 flex flex-col justify-between">
                                    <div>
                                        <h4 className="text-sm font-black text-gray-900 uppercase tracking-tight mb-2">Security Hub</h4>
                                        <p className="text-xs text-gray-400 font-medium italic">Passwords are securely encrypted.</p>
                                    </div>
                                    <button className="w-full flex items-center justify-center gap-2 py-4 bg-gray-900 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-black transition-all mt-6 shadow-xl shadow-gray-200">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                         <div className="bg-white border border-gray-100 rounded-[40px] p-8 shadow-sm group hover:border-indigo-100 transition-all">
                            ...
                            <h4 className="text-sm font-black text-gray-900 uppercase tracking-tight mb-2">Two-Factor Auth</h4>
                            <p className="text-xs text-gray-400 font-medium mb-6">Add an extra layer of security to your account.</p>
                            <span className="text-[9px] font-black text-amber-600 bg-amber-50 px-3 py-1 rounded-full uppercase tracking-widest">Coming Soon</span>
                         </div>
                         ...
                         <div className="bg-white border border-gray-100 rounded-[40px] p-8 shadow-sm group hover:border-indigo-100 transition-all">
                            ...
                            <h4 className="text-sm font-black text-gray-900 uppercase tracking-tight mb-2">Notification Feed</h4>
                            <p className="text-xs text-gray-400 font-medium mb-6">Manage alerts for stock levels and goal targets.</p>
                            <span className="text-[9px] font-black text-blue-600 bg-blue-50 px-3 py-1 rounded-full uppercase tracking-widest">Coming Soon</span>
                         </div>
                    </div>
                </div>
            </div>
