const API_URL = 'https://script.google.com/macros/s/AKfycbzOrGPQRfAZo5LztvDRcx2c4MeVmPO44bJjEFD39hF1vuD8WzsIjX9WIZv6JjYhu0Nnlg/exec';
...
async function sync() {
    ...
    try {
        const payload = {
            action: 'sync_all',
            sheet: 'N/A', // Not used for sync_all
            data: {
                Products: SAMPLE_PRODUCTS,
                Categories: SAMPLE_CATEGORIES,
                Users: [
                    { id: 'admin', username: 'admin', name: 'Amit', role: 'Owner' },
                    { id: 'staff', username: 'staff', name: 'Store Staff', role: 'Staff' }
                ]
            }
        };
        ...
        try { const result = JSON.parse(text); console.log('Sync Result:', result); } catch(e) { console.log('Raw response:', text.substring(0, 500)); }
